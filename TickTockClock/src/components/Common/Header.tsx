...
const Header: React.FC = () => {
    return (
        <header className="contents">
            <div className='col-span-7 p-4 row-span-1 rounded-3xl bg-floralWhite dark:bg-eerieBlack'>
            ...
            <div className='col-span-4 p-4 row-span-1 rounded-3xl bg-floralWhite dark:bg-eerieBlack'>
