...
const Header: React.FC = () => {
    ...
    return (
        <>
            {/* Settings button - 1x1 top-left corner */}
            <div
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-7 h-7 lg:w-10 lg:h-10 fill-base dark:fill-muted">
            ...
            <div className='col-span-3 lg:col-span-5 lg:col-start-2 lg:row-start-1 h-full p-4 rounded-3xl bg-surface dark:bg-surfaceDark flex items-center justify-center'>
