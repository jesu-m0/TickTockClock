  ...
  return (
    ...
    >
      {isDarkMode ? (
              ...
              viewBox="0 0 384 512"
              className={`fill-timberwolf lg:w-12 lg:h-12 w-8 h-8 transform transition-transform duration-300 ${lightTransition ? 'scale-0' : 'scale-100 hover:scale-105'
                }`}
            >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className={`fill-saffron lg:w-12 lg:h-12 w-8 h-8 transform transition-transform duration-300 ${darkTransition ? 'scale-0' : 'scale-100 hover:scale-105'
                  }`}
              >
