            ...
            <div className="order-5 col-span-12 lg:col-span-8 row-span-2 bg-jade rounded-3xl flex flex-col items-center justify-center overflow-hidden p-3">
                  <div className="flex flex-row gap-1 w-full flex-1">
                        <div
                              ...
                              className="bg-floralWhite dark:bg-blackOlive rounded-tl-3xl rounded-md h-full flex-1 flex items-center justify-center hover:scale-105 transition-transform duration-200 cursor-pointer"
                        >
                  ...
                  <div className="flex flex-row gap-1 w-full flex-1">
                        <div
                              ...
                              className="bg-floralWhite dark:bg-blackOlive rounded-bl-3xl rounded-md h-full flex-1 flex items-center justify-center hover:scale-105 transition-transform duration-200 cursor-pointer"
                        >
                              <p className="text-blackOlive dark:text-timberwolf font-black text-lg lg:text-2xl xl:text-3xl">-5''</p>
                        </div>
                        <div
